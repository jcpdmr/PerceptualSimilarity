...
def plot_training_progress(attempt, save_path):
    """
...
if __name__ == "__main__":
    ...
    plot_weight_evolution(
        attempt=attempt,
        n_epochs=10,
        save_path=f"{base_output_dir}/{attempt}_weight_evolution.png",
        architecture="vgg",
    )
    # Plot training progress
    plot_training_progress(
        attempt=attempt, save_path=f"{base_output_dir}/{attempt}_training_plot.png"
    )
